...
class Article(models.Model):
    ...
    created_time = models.DateTimeField(verbose_name='创建时间', default=now)
    pub_time = models.DateTimeField(verbose_name='发布时间', blank=False, null=False)
    last_mod_time = models.DateTimeField(verbose_name='修改时间', default=now)
...
class user(models.Model):
    ...
    user_paw = models.CharField(max_length=80, verbose_name="密码")
    user_leg = models.IntegerField(default=0,)
    user_email = models.CharField(max_length=20, verbose_name="邮箱")


class reply(models.Model):
    bbs_id = models.ForeignKey("Article", on_delete=models.CASCADE)
